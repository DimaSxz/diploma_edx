<?php
    ...
    while($subjects = mysql_fetch_assoc($result_1)) {
        ...
        $count_courses = mysql_fetch_assoc(mysql_query("SELECT count(*) as count_courses FROM courses WHERE user_id='$_SESSION[id]' and subject_id = '$subjects[subject_id]'") or die(mysql_error()));
        $subj_with_badges .= "<li>
